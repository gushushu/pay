package com.gushushu.pay.tfb.util;
...
import com.gushushu.pay.tfb.TFBConfig;
...
public class RSAUtils {
    ...
    public static String encrypt(String paramstr) {
        try {
            byte[] cipherData = RSAUtils.encryptByPublicKey(paramstr.getBytes(TFBConfig.serverEncodeType), TFBConfig.TFB_PUBLIC_KEY);
    ...
    public static String decrypt(String cipherData) {
        try {
            ...
            String result = new String(cipher, TFBConfig.serverEncodeType);
